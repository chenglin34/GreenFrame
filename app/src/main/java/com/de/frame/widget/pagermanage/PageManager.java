...
public class PageManager {
    ...
    /**
     * @param container 必须为activity,fragment或者view.如果是view,则该view对象必须有parent
     * @param listener  自定义展示内容和点击事件
     * @return
     */
    public static PageManager init(final Object container, final PageListener listener) {
        return new PageManager(container, listener);
    }
    ...
    public void dismiss() {
        mLoadingAndRetryLayout.dismiss();
    }
